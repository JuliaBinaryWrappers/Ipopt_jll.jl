# `Ipopt_jll.jl` (v300.1400.1700+0)

[![deps](https://juliahub.com/docs/Ipopt_jll/deps.svg)](https://juliahub.com/ui/Packages/General/Ipopt_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/94b3185212c654d465dfdf874f1bd7b06cd8e010/C/Coin-OR/Ipopt/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/coin-or/Ipopt.git (revision: `66245ceea9e613cf6ce113d430903b931cc7ff7a`)
