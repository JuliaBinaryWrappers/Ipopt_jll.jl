...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Ipopt_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("9cc047cb-c261-5740-88fc-0cf96f7bdcc7"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Ipopt", artifacts_toml) for e in artifacts["Ipopt"]]
...
if best_platform === nothing
    @debug("Unable to load Ipopt; unsupported platform $(triplet(platform_key_abi()))")
else
